 ...
 * more than a {@link QuestDetailFragment}.
 */
public class QuestDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(QuestDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(QuestDetailFragment.ARG_ITEM_ID));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, QuestListActivity.class));
            return true;
        }
